                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <div class="input-group input-group-sm" style="display: flex; align-items: center;">
                                            <!-- Button Tambah Data -->
                                            <button type="button" class="btn btn-danger" style="margin-right: 10px;" onclick="window.location.href='insert_Produk.php'">
                                                Tambah Data
                                            </button>
                                            <!-- Search Input -->
                                        ...
                                        <tbody>
                                            ...
                                            while ($hasil = mysqli_fetch_array($a)) {
                                                echo "<tr>
                                                        ...
                                                        <td>" . $hasil['Nm_Produk'] . "</td>
                                                        <td>" . $hasil['Harga'] . "</td>
                                                        <td>" . $hasil['Stok'] . "</td>
                                                        <td><a href='" . $hasil['Gambar_Produk'] . "' target='_blank'>Lihat Foto</a></td>
                                                        <td>
                                                            <button class='btn btn-warning' onclick=\"window.location.href='form.edit_Produk.php?ID_Produk=" . $hasil['ID_Produk'] . "'\">Edit</button>
                                                            <button class='btn btn-danger' onclick=\"if(confirm('Apakah Anda yakin ingin menghapus data ini?')) { window.location.href='hapus_produk.php?ID_Produk=" . $hasil['ID_Produk'] . "'; }\">Hapus</button>
                                                        </td>
                                                    </tr>";
                                            }
                                            ?>
